...
/// Self-contained cryptographic helper handling dynamic salts and SHA-256 hashing.
class SecurityHashHelper {
  const SecurityHashHelper._();

  /// Generates a cryptographically strong random salt of specified length.
  ...
  /// Hashes the given PIN combined with a dynamic salt using a pure Dart SHA-256 algorithm.
  ...
  /// Direct self-contained SHA-256 algorithm block to avoid third-party dependencies.
