...
class MockSearchTransactionsUseCase extends Mock
    implements SearchTransactionsUseCase {}
...
void main() {
  ...
  setUp(() {
    ...
    when(
      () => mockRepository.saveSearchToHistory(any()),
  ...
  testWidgets(
    'SearchScreen renders input box, history list, and transitions beautifully',
    (tester) async {
      // Set test viewport
      ...
      expect(
        find.text('جستجو در مبالغ، بانک‌ها، یادداشت‌ها...'),
        findsOneWidget,
      );
  ...
  testWidgets(
    'SearchScreen displays transactions list when search returns matched items',
    (tester) async {
      tester.view.physicalSize = const Size(1200, 1920);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
